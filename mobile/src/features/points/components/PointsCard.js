...
const styles = StyleSheet.create({
  ...
  hint: { fontFamily: fonts.body, fontSize: fontSizes.xs, color: colors.slate400, marginTop: 1 },
  ...
  progressHint: { fontFamily: fonts.body, fontSize: 10, color: colors.slate400, marginTop: 3 },
  ...
  emptyHint: {
    ...
    fontFamily: fonts.body, fontSize: fontSizes.xs, color: colors.slate400, lineHeight: 16,
  },
})
