...
const styles = StyleSheet.create({
  ...
  cardBody: { fontFamily: fonts.body, fontSize: fontSizes.xs, color: colors.slate500, marginTop: 2 },
  ...
  tierBadgeText: { fontFamily: fonts.bodySemiBold, fontSize: 11, color: colors.brand700, letterSpacing: 0.4 },
