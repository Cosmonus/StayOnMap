...
const styles = StyleSheet.create({
  ...
  phaseLabel: { fontFamily: fonts.body, fontSize: 11, color: colors.slate500, marginTop: 6 },
  ...
  finishLater: { fontFamily: fonts.body, fontSize: fontSizes.xs, color: colors.slate500, marginTop: spacing.md },
  flowFooter: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    paddingHorizontal: spacing.lg, paddingVertical: spacing.md,
  ...
  pctText: { fontFamily: fonts.body, fontSize: fontSizes.xs, color: colors.slate500 },
