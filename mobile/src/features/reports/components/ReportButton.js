...
const styles = StyleSheet.create({
  ...
  cancelButton: { flex: 1, paddingVertical: spacing.sm + 4, borderRadius: radius.md, borderWidth: 1, borderColor: colors.slate200, alignItems: 'center', minHeight: 48, justifyContent: 'center', },
  cancelButtonText: { fontFamily: fonts.bodySemiBold, fontSize: fontSizes.sm, color: colors.slate600 },
  submitButton: { flex: 1, paddingVertical: spacing.sm + 4, borderRadius: radius.md, backgroundColor: colors.danger, alignItems: 'center', minHeight: 48, justifyContent: 'center', },
  ...
  closeButton: { marginTop: spacing.lg, backgroundColor: colors.brand600, borderRadius: radius.md, paddingHorizontal: spacing.xl, paddingVertical: spacing.sm + 4, minHeight: 48, justifyContent: 'center', },
