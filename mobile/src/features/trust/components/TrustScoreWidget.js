      ...
      {hasAreaScores && (
        <View>
          ...
          <View style={styles.insightRow}>
            {/* No flood tile — see the refusal note in trust.service.js.
                Elevation lives in the spatial panel's terrain module. */}
...
const styles = StyleSheet.create({
  ...
  headerScoreMax: { fontFamily: fonts.body, fontSize: fontSizes.base, color: colors.slate500 },
  headerSub: { fontFamily: fonts.body, fontSize: fontSizes.xs, color: colors.slate500, marginTop: spacing.xs },
  divider: { height: 1, backgroundColor: colors.slate100 },
  sectionLabel: { fontFamily: fonts.bodySemiBold, fontSize: 11, color: colors.slate500, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: spacing.sm },
  ...
  insightMax: { fontFamily: fonts.body, fontSize: 11, color: colors.slate500 },
  insightLabel: { fontFamily: fonts.bodyMedium, fontSize: 11, color: colors.slate500, marginTop: 2 },
  ...
  scoreValueMax: { fontFamily: fonts.body, fontSize: 11, color: colors.slate500 },
  noReviewsBox: { backgroundColor: colors.slate50, borderRadius: radius.md, paddingVertical: spacing.md, alignItems: 'center' },
  noReviewsText: { fontFamily: fonts.body, fontSize: fontSizes.xs, color: colors.slate500 },
