// Filter schema — port of frontend/src/config/filters.js (the UI-side
...
export const TYPE_CATEGORIES = [
  ...
  { id: 'house',     label: 'House',      types: ['HOUSE', 'VILLA', 'INDEPENDENT_HOUSE'], color: '#16A34A', icon: House },
...
// `area` is search context (place search + fly), never sent as a filter param.
export const DEFAULT_FILTERS = {
  area: '',
  ...Object.fromEntries(Object.entries(PARAM_DEFS).map(([id, d]) => [id, d.def])),
}

// city/area are set by search, not the filter sheet — sheet Reset keeps them.
...
// filterStore state → API query params
...
// for finer gating; a section whose rows are all hidden is skipped.
