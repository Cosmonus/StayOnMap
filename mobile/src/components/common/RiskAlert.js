...
const LEVEL_CONFIG = {
  MEDIUM:     { label: 'Under Review',        bg: '#FFFBEB', border: '#FDE68A', text: '#92400E', icon: 'i', body: 'This property is currently being reviewed by our trust and safety team.' },
  HIGH:       { label: 'Under Investigation', bg: '#FEF2F2', border: '#FECACA', text: '#991B1B', icon: '!', body: 'This listing has been flagged for suspicious activity. Proceed with caution.' },
  SUSPICIOUS: { label: 'Suspicious Listing',  bg: '#FEF2F2', border: '#FCA5A5', text: '#7F1D1D', icon: '!', body: 'This listing has been flagged for suspicious activity. Proceed with caution.' },
}
...
const styles = StyleSheet.create({
  ...
  icon: { fontFamily: fonts.bodySemiBold, fontSize: fontSizes.sm },
  textWrap: { flex: 1 },
