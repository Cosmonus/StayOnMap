...
const PUSH_TYPES  = new Set(['APPOINTMENT_ACCEPTED', 'APPOINTMENT_REJECTED', 'LEASE_OFFERED', 'LEASE_SIGNED', 'LEASE_REJECTED', 'MESSAGE', 'SUPPORT_CASE_MESSAGE', 'SUPPORT_CASE_RESOLVED', 'SAVED_SEARCH_MATCH', 'TENANCY_UPDATE'])
