  ...
  return (
    <div className="relative flex-1">
      ...
      <input
        ...
        className={`w-full h-10 ${prefix ? 'pl-8' : 'pl-3'} ${suffix ? 'pr-12' : 'pr-3'} rounded-xl border border-slate-200 text-sm text-slate-700 placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500`}
      />
    </div>
  )
}
