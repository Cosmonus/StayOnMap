    ...
    <form onSubmit={verify} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          required autoFocus
          className="w-full px-4 py-3 border border-slate-200 rounded-xl text-center text-lg font-semibold tracking-[0.4em] focus:outline-none focus:ring-2 focus:ring-brand-600 focus:border-brand-600 transition-all bg-slate-50 placeholder:text-slate-300 placeholder:tracking-[0.4em]"
        />
      </div>
