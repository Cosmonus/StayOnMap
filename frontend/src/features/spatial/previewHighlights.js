// Compact "what's nearby" picks for map preview cards (pin popup / bottom
// sheet). Reads the same envelope facts the full spatial panel renders —
// numbers are never recomputed here, only shortened. Values are the
// property-anchored distances the read path already re-derived; shown as
// plain distance, never a walk time (see docs/spatial-intelligence.md on why
// assumed walk times were removed).
const PICKS = [
